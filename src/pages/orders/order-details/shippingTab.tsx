              ...
              <div className="-mx-3 md:flex mb-6">
                <div className="md:w-full px-3 mb-6 md:mb-0">
                  ...
                  <div className="flex gap-5">
                    <input className="appearance-none block w-full bg-white text-gray-700 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="order-type" type="text" placeholder="Local " />
            ...
            <div>
              ...
              <div className="-mx-3 md:flex mb-6">
                ...
                <div className="md:w-full px-3">
                  ...
                  <select name="" id="" className='appearance-none block w-full bg-white text-gray-700 border border-gray-500 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500'>

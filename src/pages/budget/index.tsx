  ...
  return (
    <>
      <Card className="mb-8">
        ...
        <div className="flex gap-4 flex-col items-center w-full space-y-4 ms-auto md:w-3/4 md:flex-row md:space-y-0 xl:w-1/1">
          ...
          <input type="text" className='ps-4 pe-4 h-12 flex items-center w-full xl:w-1/2 rounded-md appearance-none transition duration-300 ease-in-out text-heading text-sm focus:outline-none focus:ring-0 border border-border-base focus:border-accent bg-gray-100' placeholder='Spand Balance' disabled readOnly />
          {/* <Button className='bg-black text-sm  text-white hover:bg-black-500'>
            Filter</Button>
            <Button className='bg-transprint text-sm  border border-black-500 text-black hover:bg-white-600'>
        ...
        <div className='flex gap-4 w-1/1'>
          ...
          showCheckbox
        /> 
       <input type="number" className='ps-4 pe-4 h-12 flex items-center w-full xl:w-1/1 rounded-md appearance-none transition duration-300 ease-in-out text-heading text-sm focus:outline-none focus:ring-0 border border-border-base focus:border-accent' placeholder='$' />
    ...
    <select id="month" name="month" className='ps-4 pe-4 h-12 flex items-center w-full xl:w-1/1 rounded-md appearance-none transition duration-300 ease-in-out text-heading text-sm focus:outline-none focus:ring-0 border border-border-base focus:border-accent'>
        ...
        <option value="december">December</option>
          ...
          <div>
       <Button onClick={handlePopupToggle} className='bg-black text-sm text-white hover:bg-black-500'>
         Submit</Button>
         </div>
     </div>
      </Card>

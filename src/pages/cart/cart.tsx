      ...
      <div className="container mx-auto mt-4">
        ...
        <div className="flex flex-col">
          {products.map((product, index) => (
            <div
              key={product.id}
              className="flex flex-row justify-between items-center bg-gray-100 p-4 mb-2"
            >
              <div className="flex flex-col">
                <div className="flex gap-4 items-center">
                  <img
                    className="w-[150px]"
                    alt="product"
                    src="http://localhost:3002/_next/image?url=https%3A%2F%2Fstingray-app-mkueb.ondigitalocean.app%2Fstorage%2F2557%2Fconversions%2FVypa-BreezeHi-Vis-X-Back-NSW-Rail-Shirt-Rear-Web-scaled-thumbnail.jpg&w=1920&q=75"
                  />
                  <div>
                    ...
                    <div className="flex gap-3">
                      <textarea
                        name=""
                        id=""
                        placeholder="Staff Name/Embroidery Details"
                        className="border shadow rounded w-full text-sm"
                      ></textarea>
                      <p className="flex">
                        {' '}
              ...
              <div
                className="w-[120px] flex justify-between items-center bg-[#fff]"
        ...
        <div className="flex justify-end p-4">
          <button className="bg-transprint text-black p-2 pl-4 pr-4 border border-black rounded mr-2">
            Continue To Shopping
          </button>
          <button className="bg-black text-white p-2 pl-4 pr-4 rounded">
            Update Cart
          </button>
        </div>
      </div>

export const API_ENDPOINTS = {
  ...
  BUDGET_ASSIGN:'requestBudget',
  SHOW_REQUEST_BUDGETS:'showRequestBudget',
  APPROVE_BUDGET: 'approveRequestBudget',
  DISAPPROVE_BUDGET: 'disapproveRequestBudget',
  SHOW_REQUEST_BUDGET:'showRequestBudget',
  COMPANY: 'company',
  GET_EMPLOYEE: 'employee',
  EMPLOYEE: 'employee/create',
  CONTACT: 'contact',
  COMPOANY_GET_RESULT:'company/getResult',

...
const AddProduct = ({ initialValues }: { initialValues?: Shop }) => {
  ...
  const onSubmit = async (values: FormValues) => {
    ...
    // };
    console.log('productsvaaliiess', values);
    try {
      if (!initialValues) {
        createProduct({
          //@ts-ignore
  ...
  const handleCategoryChange = (e: any) => {
    ...
    // @ts-ignore
    const selected = categories.find((cat) => cat.name === selectedId);
    // @ts-ignore

    setSubcategories(selected ? selected.children : []); // Set subcategories from children
    // @ts-ignore
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div className="mt-3">
            ...
            >
              <div className="flex w-full gap-4">
                <div className=" w-full pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
                  ...
                  <div className="mb-2">
                    <label
                      className="flex text-body-dark font-semibold text-sm leading-none mb-3"
                      htmlFor=""
                    >
                      Product Description
                    </label>
                    ...
                    <div className="w-full">
                      ...
                      <div className="">
                        ...
                        >
                          ...
                          <option value="Size Small $50.00">
                            Size Small $50.00
                          </option>
                          <option value="Size Medium $52.00">
                            Size Medium $52.00
                          </option>
                          <option value="Size Large $54.00">
                            Size Large $54.00
                          </option>
                          <option value="Size Large $54.00">
                            Size XL $57.00
                          </option>
                          <option value="Size 2XL $60.00">
                            Size 2XL $60.00
                          </option>
                          <option value="Size 3XL $62.00">
                            Size 3XL $62.00
                          </option>
                          <option value="Size 4XL $64.00">
                            Size 4XL $64.00
                          </option>
                          <option value="Size 5XL $67.00">
                            Size 5XL $67.00
                          </option>
                          <option value="Size 7XL $70.00">
                            Size 7XL $70.00
                          </option>
                        </select>
                      </div>
            ...
            >
              ...
              <div className="text-right mb-5">
                <Button className="mr-3 bg-black border border-black-600 text-white hover:bg-transprint-700  hover:bg-white hover:text-black  items-center pl-8 pr-8">
                  Generate Variants
                </Button>
                <Button className="bg-transprent border border-red-600 text-red-600 hover:bg-transprint-700  hover:bg-white hover:text-black  items-center pl-8 pr-8">
                  Clear Variants
                </Button>
              </div>
        ...
        <div className="grid grid-cols-2 gap-3 justify-between">
          <Button className="bg-transprent border border-red-600 text-red-600 hover:bg-transprint-700  hover:bg-white hover:text-black flex gap-2 items-center pl-8 pr-8">
            Cancel
          </Button>
          <Button className="bg-black border border-black-600 text-white hover:bg-transprint-700  hover:bg-white hover:text-black flex gap-2 items-center pl-8 pr-8">
            Add product
          </Button>
        </div>
      </form>

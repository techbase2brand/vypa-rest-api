          ...
          <table className="min-w-full bg-white table-auto">
            <thead>
              <tr className="border-b">
                ...
                <th className="px-4 py-2 text-left text-sm">Orders Count</th>
            ...
            <tbody>
              {products?.map((product) => (
                <tr key={product.id} className="border-b">
                  <td className="px-4 py-2 text-xs text-[#117D0F]">#{product?.id}</td>
                  <td className="px-4 py-2 text-xs">{product?.name}</td>
                  <td className="px-4 py-2 text-xs text-[#117D0F]">{product?.orders_count}</td>
                  <td className="px-4 py-2 text-xs">${product?.price}</td>
                </tr>
              ))}
            </tbody>
          </table>

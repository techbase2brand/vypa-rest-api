  ...
  return (
    <div
      className={classNames(
        'group relative h-full cursor-pointer overflow-hidden rounded border p-4 border-accent',
        {
    ...
    >
      ...
      <div className="absolute flex opacity-100 top-4 end-4 space-s-2 group-hover:opacity-100">
        {onEdit && (
          <button

  ...
  return childMenu && childMenu?.length ? (
    miniSidebar && width >= RESPONSIVE_WIDTH ? (
      ...
      <>
        <motion.div
          ...
          onClick={onClick}
        >
          <div className={cn('flex w-full items-center text-sm text-white')}>
            ...
            <ChevronRight
              className={cn(
                'h-3.5 w-3.5 shrink-0 text-white opacity-75 transition-transform duration-300 ltr:ml-auto ltr:mr-0 rtl:mr-auto rtl:ml-0',
    ...
    <Link
      ...
      className={cn(
        ...
        sanitizedPath === href
          ? `font-medium !text-white-hover ${
              !miniSidebar
                ? 'bg-gradient-to-r from-customGreenLight via-customGreenDark to-customGreenDark hover:!bg-gradient-to-r from-customGreenLight via-customGreenDark to-customGreenDark'
                : ''
            }`
          : '',
      )}
